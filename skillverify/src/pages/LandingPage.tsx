...
const FEATURES = [
    {
        ...
        desc: 'Playwright-powered scraping extracts your real tech stack, frameworks, libraries, and project quality signals from any repository.',
    ...
    },
    {
        ...
        desc: '5 MCQs + 2 coding challenges per language — dynamically generated from our live question bank, tailored to your exact stack.',
    ...
    },
    {
        icon: Shield,
        title: 'AI Proctoring',
        desc: 'Tab-switch detection, window blur monitoring, and automated violation tracking. Auto-submit after 3 violations.',
    ...
    },
    {
        icon: Brain,
        title: 'Skill Engine',
        desc: 'AI-generated 4-week advanced mastery paths tailored to your language stack. One actionable task per week to build real, measurable skill over time.',
    ...
    },
    {
        ...
        desc: 'Weighted formula combining accuracy, repo strength, behaviour persistence, code efficiency, and integrity score.',
        color: 'from-emerald-500 to-teal-700',
        badge: 'Module 5',
    },
    {
        icon: Sparkles,
        title: 'Transparent AI Reports',
        desc: 'Gemini 2.5 Flash generates human-readable skill explanations, improvement suggestions, and personalised feedback.',
